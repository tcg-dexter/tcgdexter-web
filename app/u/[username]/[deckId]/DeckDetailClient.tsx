        ...
        <>
          <div className="flex items-center gap-3">
            <button
              ...
              className={`flex-1 min-w-0 inline-flex items-center justify-center gap-1.5 rounded-full border border-transparent px-[3px] py-2 text-sm font-semibold transition-all ${
            ...
            <QRCodeButton
              deckList={deckList}
              analysis={analysis}
              className="flex-1 min-w-0 inline-flex items-center justify-center gap-1.5 rounded-full border border-transparent bg-gradient-brand-reverse bg-origin-border px-[3px] py-2 text-sm font-semibold text-white shadow-brand hover:shadow-brand-lg transition disabled:opacity-50"
            />
            ...
            <div ref={settingsRef} className="relative flex-1 min-w-0">
              <button
                ...
                className="w-full inline-flex items-center justify-center rounded-full bg-black border border-transparent px-[3px] py-[11px] text-white disabled:opacity-50 transition-opacity hover:opacity-80 touch-manipulation"
              >
                <svg
